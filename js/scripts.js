$(document).ready(function() {
  ...
  $(".click-parameters").click(function() {
  ...
  $(".click-chainingmethods").click(function() {
    $("#chainingmethods-term").toggle();
    $("#chainingmethods-definition").toggle();
  });

  $(".click-strings").click(function() {
    $("#strings-term").toggle();
    $("#strings-definition").toggle();
  });

  $(".click-booleans").click(function() {
    $("#booleans-term").toggle();
    $("#booleans-definition").toggle();
  });

  $(".click-undefined").click(function() {
    $("#undefined-term").toggle();
    $("#undefined-definition").toggle();
  });

  $(".click-nan").click(function() {
    $("#nan-term").toggle();
    $("#nan-definition").toggle();
  });

  $(".click-escape").click(function() {
    $("#escape-term").toggle();
